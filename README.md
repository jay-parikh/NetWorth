...
![Release](https://img.shields.io/badge/release-v1.7.5-blue)
...
pytest                                 # 385 tests — golden values, parsers, scenario
...
| [docs/RELEASES.md](docs/RELEASES.md) | Milestone plan & acceptance criteria (R0 → v1.7.5) |
