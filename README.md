...
![Release](https://img.shields.io/badge/release-v1.6.2-blue)
...
pytest                                 # 258 tests — golden values, parsers, scenario
...
| [docs/RELEASES.md](docs/RELEASES.md) | Milestone plan & acceptance criteria (R0 → v1.6.2) |
